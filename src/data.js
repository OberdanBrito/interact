/* Camada de dados (mock). Isolada para futura troca por API real:
...
/* Campos: id, readMode ("auto" | "ack"), categoryId, urgent, title,
   body[], author {name, role}, dateISO, likeBase (curtidas prévias
   simuladas de outros colegas). */
const POSTS = [
  {
    id: "p01",
    readMode: "auto",
